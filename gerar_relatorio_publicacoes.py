...
COORDENADORES_MAPEADOS = {
    ...
    normalizar("GUSTAVO LOPES ALENCAR FILHO"):                    "HELANZIA DE ARAUJO XAVIER WICHAMNN",
    normalizar("KELIANE DE OLIVEIRA"):                            "HELANZIA DE ARAUJO XAVIER WICHAMNN",
    normalizar("MARCELO LIMA ARRAIS"):                            "HELANZIA DE ARAUJO XAVIER WICHAMNN",
    normalizar("NATALIA PAIVA DE PAULA"):                         "HELANZIA DE ARAUJO XAVIER WICHAMNN",
    normalizar("ROBERTA RAYANNE VASCONCELOS BOTO"):               "HELANZIA DE ARAUJO XAVIER WICHAMNN",
    normalizar("VICTOR EMANOEL FRADIQUE ACCIOLY FONTENELE"):      "HELANZIA DE ARAUJO XAVIER WICHAMNN",
