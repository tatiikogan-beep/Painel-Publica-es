...
COORDENADORES_MAPEADOS = {
    ...
    # Auto-mapeados: coordenadores ativos (Ativo=Sim) mapeados para si mesmos
    normalizar("ALANIS ALVES DE SOUSA"): "ALANIS ALVES DE SOUSA",
    normalizar("ALEXIA ALENCAR CAPIBARIBE"): "ALEXIA ALENCAR CAPIBARIBE",
    normalizar("ALYSSON NARBAL DE OLIVEIRA SOMBRA"): "ALYSSON NARBAL DE OLIVEIRA SOMBRA",
    normalizar("ANDRE VIANA GARRIDO"): "ANDRE VIANA GARRIDO",
    normalizar("ANNA JULIA MUNIZ SILVA"): "ANNA JULIA MUNIZ SILVA",
    normalizar("ANTONIO EDUARDO GOES AGUIAR FILHO"): "ANTONIO EDUARDO GOES AGUIAR FILHO",
    normalizar("ARMANDO HELIO ALMEIDA MONTEIRO DE MORAES"): "ARMANDO HELIO ALMEIDA MONTEIRO DE MORAES",
    normalizar("BARBARA EVELYN PIO SILVA"): "BARBARA EVELYN PIO SILVA",
    normalizar("CARMEN MARIA HOLANDA DE LIMA"): "CARMEN MARIA HOLANDA DE LIMA",
    normalizar("DANIEL BARROS DE OLIVEIRA"): "DANIEL BARROS DE OLIVEIRA",
    normalizar("EDUARDO BLASQUES MARTINE"): "EDUARDO BLASQUES MARTINE",
    normalizar("EMERSON TRAVASSOS TORQUATO"): "EMERSON TRAVASSOS TORQUATO",
    normalizar("EVILANY GABRIELA BRAGA PONTES"): "EVILANY GABRIELA BRAGA PONTES",
    normalizar("FRANCOISE CATHERINE SOUZA ALVES"): "FRANCOISE CATHERINE SOUZA ALVES",
    normalizar("GABRIEL BERTACCO HADDAD"): "GABRIEL BERTACCO HADDAD",
    normalizar("GIOVANNA CAMPOS PEREIRA"): "GIOVANNA CAMPOS PEREIRA",
    normalizar("GIOVANNA CESAR FERREIRA"): "GIOVANNA CESAR FERREIRA",
    normalizar("GUSTAVO LOPES ALENCAR FILHO"): "GUSTAVO LOPES ALENCAR FILHO",
    normalizar("IRENE FLAVIA SERENARIO"): "IRENE FLAVIA SERENARIO",
    normalizar("JAMILE BARRETO"): "JAMILE BARRETO",
    normalizar("JULIANA DE OLIVEIRA ROCHA"): "JULIANA DE OLIVEIRA ROCHA",
    normalizar("JULIANA MIRELLA ALVES RODRIGUES"): "JULIANA MIRELLA ALVES RODRIGUES",
    normalizar("KARYNA SARAIVA LEAO GAYA"): "KARYNA SARAIVA LEAO GAYA",
    normalizar("KELIANE DE OLIVEIRA"): "KELIANE DE OLIVEIRA",
    normalizar("LETICIA OLIVEIRA DA SILVA"): "LETICIA OLIVEIRA DA SILVA",
    normalizar("MARIA IMACULADA GORDIANO OLIVEIRA BARBOSA"): "MARIA IMACULADA GORDIANO OLIVEIRA BARBOSA",
    normalizar("MARIA RITA VITOR DE ARAUJO"): "MARIA RITA VITOR DE ARAUJO",
    normalizar("MARIANA MOTA FROTA"): "MARIANA MOTA FROTA",
    normalizar("MONIQUE DE KAROLIN SILVA DA COSTA"): "MONIQUE DE KAROLIN SILVA DA COSTA",
    normalizar("NATALIA PAIVA DE PAULA"): "NATALIA PAIVA DE PAULA",
    normalizar("PALOMA KELLEN BARBOSA DA SILVA"): "PALOMA KELLEN BARBOSA DA SILVA",
    normalizar("PAULO MARCIO SOARES DE CARVALHO FILHO"): "PAULO MARCIO SOARES DE CARVALHO FILHO",
    normalizar("ROBERTA RAYANNE VASCONCELOS BOTO"): "ROBERTA RAYANNE VASCONCELOS BOTO",
    normalizar("RONALD FEITOSA AGUIAR FILHO"): "RONALD FEITOSA AGUIAR FILHO",
    normalizar("SANE BORGES BORGOMONI"): "SANE BORGES BORGOMONI",
    normalizar("TARCILLA GOES BARBOSA"): "TARCILLA GOES BARBOSA",
    normalizar("TATIANA KOGAN"): "TATIANA KOGAN",
    normalizar("TATIANE CARMO SANTA ROSA"): "TATIANE CARMO SANTA ROSA",
    normalizar("THALLYS ANDERSON FERREIRA DE LIMA"): "THALLYS ANDERSON FERREIRA DE LIMA",
    normalizar("TICIANNA PIRES DE SOUZA"): "TICIANNA PIRES DE SOUZA",
    normalizar("VANESSA NUNES HOLANDA"): "VANESSA NUNES HOLANDA",
    normalizar("VICTOR EMANOEL FRADIQUE ACCIOLY FONTENELE"): "VICTOR EMANOEL FRADIQUE ACCIOLY FONTENELE",
    normalizar("YURI GONDIM DE AMORIM"): "YURI GONDIM DE AMORIM",
}
...
def _build_coord(ws, df, col_resp, mapeamento, d_str, total):
    ...
    if col_resp:
        for v in df[col_resp].dropna():
            c = mapeamento.get(normalizar(str(v)),'—')
            ct[c] = ct.get(c,0)+1
    ...
    if dados:
        ch = BarChart(); ch.type='bar'; ch.style=10; ch.title='Publicações por Coordenador'
        ch.width=22; ch.height=14
        n = len(dados)
        ch.add_data(Reference(ws,min_col=2,min_row=2,max_row=2+n),titles_from_data=True)
        ch.set_categories(Reference(ws,min_col=1,min_row=3,max_row=2+n))
        ch.series[0].graphicalProperties.solidFill='2E4D8A'
        ws.add_chart(ch,'D3')
